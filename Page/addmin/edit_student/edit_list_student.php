    ...
    <section class="main">
        ...
        <div class="sidebar">
            <div class="sidebar-top">
                ...
                <ul class="sb-ul">
                    <li>
                        <a href="edit_list_student.php?id=<?php echo $id?>"><i class="fa-solid fa-user fontawesome"></i></i>โปรไฟล์</a>
                    </li>
        ...
        <div class="dashboard">
            ...
            <div class='data' style="display: flex; justify-content: center;">
                <img class='image' src='<?php if ($row['member_img'] == '') echo '../../images/img_avatar.png';
                                        else echo '../../student/uploads/' . $row['member_img']; ?>' width='167px' height='166px'>
            </div>
            ...
            <div class="dashboard-bottom">
                <a href="edit_Profile.php?id=<?php echo $id?>" class="btn button-style-change-profile ">
                    <i class='fa-solid fa-image-portrait style-icon-CPF'></i>
                    เปลี่ยนรูปโปรไฟล์</button>
                </a>
                <a href="edit_img_profile.php?id=<?php echo $id?>" class="btn button-style-change-private">
