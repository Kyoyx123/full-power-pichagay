...
<head>
    ...
    <link rel="stylesheet" href="../addquestion4/addquestion.css">
...
<body>
    ...
    <div class="dashboard">
        <table>
            ...
            include('connectdb.php');
            $sql = "SELECT * FROM question5 WHERE questionid = '$id' and id = '$q_id' ";
            ...
            while ($row = mysqli_fetch_assoc($result)) { ?>
                ...
                <tr>
                    <td>ข้อที่<?php echo " ".$order++?></td>
                    <td> <img class='image' src="<?php if ($row['choice5_img'] == '') echo '../../images/img_avatar.png';
                                        else echo 'uploads/' . $row['choice5_img']; ?>" width='167px' height='166px'></td>
                </tr>
            <?php } ?>
        </table>
    </div>
