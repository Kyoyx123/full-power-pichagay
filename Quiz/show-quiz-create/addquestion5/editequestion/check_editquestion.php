...
if(isset($_POST['create'])){
    $sql = "SELECT * FROM question5 where id = $page_id";
    ...
    $sql = "UPDATE question5 SET questionname = '$questionname', choice1 = '$choice1', choice2 = '$choice2', choice3 = '$choice3', choice4 = '$choice4', choice5 = '$choice5', answer = '$answer' ,question_img = '$url1', choice1_img = '$url2', choice2_img = '$url3',  choice3_img = '$url4', choice4_img = '$url5' , choice5_img = '$url6'  WHERE  id = '$page_id' ";
